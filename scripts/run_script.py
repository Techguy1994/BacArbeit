...
def handle_arguments():
    ...
    if number == 200:
        subprocess.call(["python3", "run_inference.py", "-api", "tf", "-t", "class", "-m", "lite-model_mobilenet_v3_large_100_224_fp32_1.tflite", "-imgp", "/home/pi/marounel-chayeb/BacArbeit/ILSVRC_val_5000/",  "-l", "mobilenet_tflite.txt", "-opd", "-ni", "1"], shell=False)
    if number == 201:
        subprocess.call(["python3", "run_inference.py", "-api", "tf", "-t", "class", "-m", "lite-model_mobilenet_v3_large_100_224_uint8_1.tflite", "-imgp", "/Users/marounel-chayeb/BacArbeit/ILSVRC_val_5000/",  "-l", "mobilenet_tflite.txt", "-opd", "-ni", "1"], shell=False)
    if number == 202:
        subprocess.call(["python3", "run_inference.py", "-api", "tf", "-t", "class", "-m", "lite-model_mobilenet_v3_large_100_224_uint8_1.tflite", "-imgp", "/Users/marounel-chayeb/BacArbeit/ILSVRC_val_5000/",  "-l", "mobilenet_tflite.txt", "-opd", "-ni", "1"], shell=False)
    if number == 203:
        subprocess.call(["python3", "run_inference.py", "-api", "tf", "-t", "class", "-m", "lite-model_mobilenet_v3_large_100_224_uint8_1.tflite", "-imgp", "/Users/marounel-chayeb/BacArbeit/ILSVRC_val_5000/",  "-l", "mobilenet_tflite.txt", "-opd", "-ni", "1"], shell=False)
